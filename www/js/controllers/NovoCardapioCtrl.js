...
angular
    ...
    .module('app.novocardapio', ['angularFileUpload'])


    .controller('NovoCardapioCtrl', ['$scope', 'FileUploader','$http','$ionicModal', '$timeout', '$stateParams','$location', function($scope, FileUploader,$http, $ionicModal, $timeout, $stateParams,$location) {
