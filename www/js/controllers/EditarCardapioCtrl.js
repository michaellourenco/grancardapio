...
angular
    ...
    .module('app.editarcardapio', ['angularFileUpload'])


    .controller('EditarCardapioCtrl', ['$scope', 'FileUploader','$http','$ionicModal', '$timeout', '$stateParams','$location', function($scope, FileUploader,$http, $ionicModal, $timeout, $stateParams,$location) {
